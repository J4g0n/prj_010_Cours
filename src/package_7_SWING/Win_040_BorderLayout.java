 ...
 */
public class Win_040_BorderLayout extends JFrame{
    JButton btn1,  btn2, btn3, btn4, btn5, btn6; // Bouton à cliquer
    JPanel panneauPrincipal;

    public Win_040_BorderLayout() throws HeadlessException {
        super();
        ...
        // ici: aucun
        panneauPrincipal.setLayout(new BorderLayout(2, 3));

        // ajouter les composants au panel
        panneauPrincipal.add("North", btn1);
        panneauPrincipal.add("West", btn2);
        panneauPrincipal.add("South", btn3);
        panneauPrincipal.add("East", btn4);
        panneauPrincipal.add("Center", btn5);
